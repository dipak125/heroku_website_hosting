            ...
            <Paper elevation={10} style={paperStyle}>
                ...
                <FormControl style={formStyle}>
                    ...
                    <Select defaultValue="" id="grouped-select">
                       ...
                       <Link to="/addpatient"> <MenuItem value={1}><PersonAddIcon />&nbsp;&nbsp;Add New Patient</MenuItem></Link>
                        <Link to="/delete"><MenuItem value={2}><UpdateIcon />&nbsp;&nbsp;Update Details & Delete</MenuItem></Link>
